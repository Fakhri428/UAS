<nav x-data="{ open: false }" class="border-b-2 border-ink bg-brand-yellow sticky top-0 z-30">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                        <x-application-mark />
                        <span class="hidden sm:block text-base font-black tracking-tight text-ink">Koukan Board</span>
                    </a>
                </div>
                        ...
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="nb-btn nb-btn-white py-1">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex text-sm border-2 border-ink rounded-full focus:outline-none focus:border-ink transition hover:shadow-nb-sm">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-ink hover:text-white hover:bg-ink focus:outline-none focus:bg-ink focus:text-white transition duration-150 ease-in-out border-2 border-transparent hover:border-ink">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('market') }}" :active="request()->routeIs('home', 'market', 'offers.show', 'needs.show')">
                {{ __('Koukan Market') }}
            </x-responsive-nav-link>
